---
title: 'Acessibilidade Web: Pequenos ajustes, grande impacto'
slug: 'acessibilidade-web-ajustes-impacto'
description: 'Como tornar o seu site utilizável por todos com práticas simples de HTML semântico e contraste de cores.'
authors: ['ana-souza']
pubDate: 2026-04-10
image:
...
taxonomies:
  categories: ['Design']
  tags: ['Acessibilidade', 'UX', 'HTML', 'Inclusão']
draft: false
---

Quando se fala em acessibilidade web, muitos imaginam projetos caros, longos e cheios de regras difíceis de seguir. Na prática, a maior parte dos ganhos de acessibilidade vem de **pequenos ajustes conscientes** que melhoram a experiência para todos os utilizadores - não apenas para pessoas com deficiência.
...
## Navegação por teclado: não é opcional
